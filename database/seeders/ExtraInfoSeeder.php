...
class ExtraInfoSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('extra_infos')->insert([
            ...
            ['id' => 10, 'patientId' => 17, 'historyBreath' => 'Đôi khi khó thở khi vận động', 'placeId' => 4, 'oldForms' => '[]', 'sendForms' => '[]', 'moreInfo' => 'Cần theo dõi huyết áp', 'created_at' => '2025-11-28 13:49:34'],
            ...
            ['id' => 15, 'patientId' => 22, 'historyBreath' => 'Tiền sử viêm phổi năm 2020', 'placeId' => 4, 'oldForms' => '[]', 'sendForms' => '[]', 'moreInfo' => 'Cần chăm sóc răng miệng tốt', 'created_at' => '2025-11-28 13:49:34'],
